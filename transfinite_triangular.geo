// This geo script creates a transfinite (structured) triangular grid
// in the rectangular doamin. Boundary tags are shown in the sketch below.
// Options commented and used on the line of the command 'Transfinite surface'
// can be used to control the orientation of the splitting of the rectangles.
//
//             3
//      ----------------
//      |              |
